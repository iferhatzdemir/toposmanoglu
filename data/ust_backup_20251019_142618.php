...
/* Header Ana Bölüm - Hover Renkleri */
header.version_1 .main_header ul.top_tools > li a:hover {
    color: var(--rose-primary) !important;
}

/* Sepet Badge - Gül Kurusu Gradient */
header.version_1 .main_header ul.top_tools > li a.cart_bt strong {
    background: linear-gradient(135deg, var(--rose-primary), var(--rose-dark)) !important;
    color: #FFFFFF !important;
    font-weight: 700;
    box-shadow: 0 2px 8px rgba(212, 165, 165, 0.4) !important;
...
header.version_1 .main_header ul.top_tools > li .dropdown-access .dropdown-menu {
    border-top: 2px solid #E8B4B8 !important;
}
...
/* Sepet Badge - Alt Navigasyon */
header.version_1 .main_nav ul.top_tools > li a.cart_bt strong {
    background: linear-gradient(135deg, #E8B4B8, #d9a4a9) !important;
...
header.version_1 .main_nav .custom-search-input:hover {
...
/* Sepet Dropdown Butonları */
header ul.top_tools .dropdown-cart .dropdown-menu .btn_1 {
    background: linear-gradient(135deg, #E8B4B8, #d9a4a9) !important;
    color: #2C3E50 !important;
...
header ul.top_tools .dropdown-cart .dropdown-menu .btn_1:hover {
    background: linear-gradient(135deg, #d9a4a9, #c99499) !important;
    transform: translateY(-2px);
    box-shadow: 0 4px 12px rgba(232, 180, 184, 0.3) !important;
}

header ul.top_tools .dropdown-cart .dropdown-menu .btn_1.outline {
    background: transparent !important;
    border: 2px solid #E8B4B8 !important;
    color: #E8B4B8 !important;
}

header ul.top_tools .dropdown-cart .dropdown-menu .btn_1.outline:hover {
...
.categories ul li > span a:before {
    background-color: #E8B4B8 !important;
}
...
/* İkon Hover'ları */
header ul.top_tools > li a.wishlist:hover,
header ul.top_tools > li a.access_link:hover {
    color: #E8B4B8 !important;
}

/* Sepet Badge Pozisyon Düzeltmeleri */
...
@media (max-width: 767px) {
    ...
    /* Sepet İkonu Arka Plan Düzeltmesi - Mobil */
    header.version_1 .main_nav ul.top_tools > li a.cart_bt {
        background: transparent !important;
        padding: 8px !important;
    }

    /* Tüm Top Tools İkonları için Arka Plan Temizleme */
    ...
    header.version_1 .main_nav ul.top_tools > li a:hover,
    header.version_1 .main_nav ul.top_tools > li a:focus,
    header.version_1 .main_nav ul.top_tools > li a:active {
        background: transparent !important;
        background-color: transparent !important;
    }

    /* Mobil İkonlar Hizalama */
    header.version_1 .main_nav ul.top_tools {
        display: flex !important;
    ...
    header.version_1 .main_nav ul.top_tools > li {
        display: flex !important;
        align-items: center !important;
    ...
    /* İkon boyutları ve pozisyonları */
    header.version_1 .main_nav ul.top_tools > li a i,
    header.version_1 .main_nav ul.top_tools > li a svg {
    ...
    /* Hamburger Menü Hizalama */
    header.version_1 .main_nav ul.top_tools > li a.btn_cat_mob {
        width: 36px !important;
        height: 36px !important;
        min-width: 36px !important;
    }

    header.version_1 .main_nav ul.top_tools > li a.btn_cat_mob .hamburger {
        padding: 0 !important;
        width: 36px !important;
        height: 36px !important;
        display: flex !important;
    ...
    header.version_1 .main_nav ul.top_tools > li a.btn_cat_mob .hamburger-box {
        width: 20px !important;
        height: 18px !important;
    }
    ...
    /* Span metinlerini gizle (sadece ikonlar görünsün) */
    header.version_1 .main_nav ul.top_tools > li a span:not(.hamburger):not(.hamburger-box):not(.hamburger-inner) {
        display: none !important;
    }

    /* Dropdown menüleri gizle mobilde */
    header.version_1 .main_nav ul.top_tools > li .dropdown-menu {
        display: none !important;
    }
    ...
    /* Col genişlikleri - ikonlar için daha fazla yer */
    header.version_1 .main_nav .col-md-3:last-child {
		...
		<div class="container">
			...
			$sepetTutar=0;
				...
				?>
						...
						?>
						<li>
							<a href="<?=SITE?>favorilerim" class="wishlist"><span>Favoriler</span></a>
						</li>
						<li>
							<div class="dropdown dropdown-access">
								<a href="<?=SITE?>uyelik" class="access_link"><span>Hesap</span></a>
								<div class="dropdown-menu">
									<?php
