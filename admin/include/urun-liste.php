      ...
      <div class="container-fluid">
        <div class="row align-items-center mb-3">
          <div class="col-sm-6">
            ...
            ?>
            <h1 class="m-0" style="color: #9f1239; border-left: 4px solid #f43f5e; padding-left: 15px;">Urun Listesi <small class="text-muted">(<?=$toplamKayit?> kayit)</small></h1>
          </div>
          <div class="col-sm-6 text-right">
            <a href="<?=SITE?>urun-ekle" class="btn btn-primary">
              <i class="fas fa-plus mr-1"></i> Yeni Urun Ekle
            </a>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th style="width:100px;">Vitrin</th>
                <th style="width:150px;">Tarih</th>
                <th style="width:320px;">Islem</th>
              </tr>
              </thead>
              <tbody>
              <?php
            ...
            if($veriler[$i]["vitrindurum"]==1){$vitrinaktifpasif=' checked="checked"';}else{$vitrinaktifpasif='';}
                        ...
                        <tr>
                          ...
                          <td>
                            <div style="display: flex; align-items: center;">
                              <div style="margin-right: 15px;">
                                <img src="<?=ANASITE?>images/urunler/<?=$veriler[$i]["resim"]?>" class="product-image" style="height: 60px; width: 60px; object-fit: cover;">
                              </div>
                              <div>
                          ...
                          <td>
                            <a href="<?=SITE?>urun-duzenle/<?=$veriler[$i]["ID"]?>" class="btn btn-sm btn-warning" title="Duzenle">
                              <i class="fas fa-edit"></i>
                            </a>
                            <a href="<?=SITE?>urun-stok/<?=$veriler[$i]["ID"]?>" class="btn btn-sm btn-dark" title="Stok Yonetimi">
                              <i class="fas fa-boxes"></i>
                            </a>
                            <a href="<?=SITE?>resimler/urunler/<?=$veriler[$i]["ID"]?>" class="btn btn-sm btn-primary" title="Resim Yonetimi">
                              <i class="fas fa-images"></i>
                            </a>
                            <a href="<?=SITE?>urun-sil/<?=$veriler[$i]["ID"]?>" class="btn btn-sm btn-danger silmeAlani" title="Kaldir">
                ...
                else
                {
                    ...
                    <tr>
                      <td colspan="6" class="text-center py-5">
                        <p class="text-muted mb-3">Henuz urun bulunamadi</p>
                        <a href="<?=SITE?>urun-ekle" class="btn btn-primary">
                          <i class="fas fa-plus"></i> Ilk Urunu Ekle
                        </a>
                      </td>
                    </tr>
                    <?php
