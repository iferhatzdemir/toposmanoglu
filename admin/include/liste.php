      ...
      <div class="container-fluid">
        <div class="row align-items-center mb-3">
          <div class="col-sm-6">
            ...
            ?>
            <h1 class="m-0" style="color: #9f1239; border-left: 4px solid #f43f5e; padding-left: 15px;"><?=$kontrol[0]["baslik"]?> <small class="text-muted">(<?=$toplamKayit?> kayit)</small></h1>
          </div>
          <div class="col-sm-6 text-right">
            <a href="<?=SITE?>ekle/<?=$kontrol[0]["tablo"]?>" class="btn btn-primary">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"><?=$kontrol[0]["baslik"]?> Listesi</h3>
          </div>
          <div class="card-body">
				...
				if($veriler!=false)
				{
					...
					for($i=0;$i<count($veriler);$i++)
					{
                        ...
                        <tr>
                          <td><?=$sira?></td>
                          <td>
                            <div style="font-weight: 600; margin-bottom: 0.3rem; color: #9f1239;">
                          ...
                          <td>
                            <a href="<?=SITE?>duzenle/<?=$kontrol[0]["tablo"]?>/<?=$veriler[$i]["ID"]?>" class="btn btn-sm btn-warning" title="Duzenle">
                              <i class="fas fa-edit"></i> Duzenle
                            </a>
                            <a href="<?=SITE?>resimler/<?=$kontrol[0]["tablo"]?>/<?=$veriler[$i]["ID"]?>" class="btn btn-sm btn-primary" title="Resim Yonetimi">
                              <i class="fas fa-images"></i> Resimler
                            </a>
                            <a href="<?=SITE?>sil/<?=$kontrol[0]["tablo"]?>/<?=$veriler[$i]["ID"]?>" class="btn btn-sm btn-danger silmeAlani" title="Kaldir">
                ...
                else
                {
                    ...
                    <tr>
                      <td colspan="5" class="text-center py-5">
                        <p class="text-muted mb-3">Henuz kayit bulunamadi</p>
                        <a href="<?=SITE?>ekle/<?=$kontrol[0]["tablo"]?>" class="btn btn-primary">
                          <i class="fas fa-plus"></i> Ilk Kaydi Ekle
                        </a>
                      </td>
                    </tr>
                    <?php
