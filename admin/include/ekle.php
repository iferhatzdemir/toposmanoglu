    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row align-items-center mb-3">
          <div class="col-sm-6">
            <h1 class="m-0" style="color: #9f1239; border-left: 4px solid #f43f5e; padding-left: 15px;"><?=$kontrol[0]["baslik"]?> Ekle</h1>
          </div>
             ...
             <div class="card-body">
               <form action="#" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="baslik" placeholder="Başlık giriniz" name="baslik">
                 </div>

                 <div class="form-group">
                   <label for="metin">Açıklama</label>
                   <textarea class="textarea form-control" id="metin" name="metin" rows="10"></textarea>
                 </div>
                 ...
                 <div class="form-group">
                   ...
                   $sirano=$VT->IDGetir($kontrol[0]["tablo"]);
                   if($sirano!=false){
                     echo $sirano;
                   }
                   else
