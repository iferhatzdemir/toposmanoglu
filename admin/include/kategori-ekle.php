    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row align-items-center mb-3">
          <div class="col-sm-6">
            <h1 class="m-0" style="color: #9f1239; border-left: 4px solid #f43f5e; padding-left: 15px;">Kategori Ekle</h1>
          </div>
             ...
             <div class="card-body">
               <form action="#" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="baslik" placeholder="Kategori başlığı giriniz" name="baslik">
                 </div>
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="anahtar" placeholder="anahtar, kelimeler, virgülle, ayrılmış" name="anahtar">
                 </div>

                 <div class="form-group">
                   <label for="description">Meta Description</label>
                   <input type="text" class="form-control" id="description" placeholder="Arama motorları için kısa açıklama" name="description">
                 </div>
