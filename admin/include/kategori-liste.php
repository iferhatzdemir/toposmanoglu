      ...
      <div class="container-fluid">
        <div class="row align-items-center mb-3">
          <div class="col-sm-6">
            ...
            ?>
            <h1 class="m-0" style="color: #9f1239; border-left: 4px solid #f43f5e; padding-left: 15px;">Kategori Listesi <small class="text-muted">(<?=$toplamKayit?> kayit)</small></h1>
          </div>
          <div class="col-sm-6 text-right">
            <a href="<?=SITE?>kategori-ekle" class="btn btn-primary">
                        ...
                        <tr>
                          ...
                          if($veriler[$i]["tablo"]=="modul")
                          {
                              ...
                              <span class="badge badge-dark">
                                <i class="fas fa-puzzle-piece"></i> AKTIF MODUL
                              </span>
                              <?php
                          }
                          else
                          ...
                          <td>
                            <a href="<?=SITE?>kategori-duzenle/<?=$veriler[$i]["ID"]?>" class="btn btn-sm btn-warning" title="Duzenle">
                              <i class="fas fa-edit"></i> Duzenle
                            </a>
                            <?php
                              if($veriler[$i]["tablo"]=="modul")
                              {
                                // Modul ise silme butonu gosterme
                              }
                              else
                              {
                                ?>
                                <a href="<?=SITE?>kategori-sil/<?=$veriler[$i]["ID"]?>" class="btn btn-sm btn-danger silmeAlani" title="Kaldir">
                ...
                else
                {
                    ...
                    <tr>
                      <td colspan="5" class="text-center py-5">
                        <p class="text-muted mb-3">Henuz kategori bulunamadi</p>
                        <a href="<?=SITE?>kategori-ekle" class="btn btn-primary">
                          <i class="fas fa-plus"></i> Ilk Kategoriyi Ekle
                        </a>
                      </td>
                    </tr>
                    <?php
